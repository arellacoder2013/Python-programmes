...
def main():
  ...
  with st.form("image_form"):
    raw=st.text_area("Image description",height=120,placeholder="Example: A cozy cabin in snowy mountains at sunrise, cinematic lighting",)
    ...
    if submit:
        ...
        st.image(img,caption="GEnearted image",use_container_width=True)
